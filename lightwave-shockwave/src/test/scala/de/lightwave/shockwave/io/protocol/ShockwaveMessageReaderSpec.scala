...
class ShockwaveMessageReaderSpec extends FunSuite {
  ...
  private def initReader(str: String) = new ShockwaveMessageReader(MessageHeader(0, 0), ByteString.fromString(str))
}
